...
export class LayoverForm {
  ...
  async submitForm() {
    ...
    const pdfFields: EmptyMilesPDFFields = {
      ...
      si: `TONU: ${this.formBody.value.specialInstructions?.emptyMiles} - FREIGHT BILL: ${this.formBody.value.specialInstructions?.freightBill} - OWED: ${this.formBody.value.specialInstructions?.owed} per mile for ${this.formBody.value.specialInstructions?.emptyMiles} Miles - TRUCK #: ${this.formBody.value.specialInstructions?.truckNumber}`,
      pp: "X",
      con1: "TONU",
      ...
      psy1: "N",
      psn1: "N",
      asi1: `REIMBURSE TONU (${this.formBody.value.specialInstructions?.emptyMiles})`,
      cd1: `TONU (${this.formBody.value.specialInstructions?.emptyMiles})`,
      cd2: `*** TONU ${this.formBody.value.specialInstructions?.emptyMiles} TONU`,
